...
Evidence: `task021-native-standard-no-color.png`, `task021-native-custom-no-input.png`, `task021-native-invalid-navigation.png` and `INTERACTION_BROWSER_LOG.md`.
...
Evidence: `INTERACTION_BROWSER_LOG.md` records the direct document-byte inspection.
...
Evidence: `task021-console-errors.png` and `task021-network-boundary.png`.
...
|---|---|---:|---|
| `task021-default-1440.png` | PNG / `89504e470d0a1a0a` | 1440 x 2858 | `410993b4ad9f73cda5829121bf785abe3bb39349a7b7ac78e55d9f0e02aa2abc` |
| `task021-default-1024.png` | PNG / `89504e470d0a1a0a` | 1024 x 2483 | `3575ee9a10bfd66fff1a27de3f0e93cddd7b6ff540729aac8a0fc058dcdc86ca` |
| `task021-default-768.png` | PNG / `89504e470d0a1a0a` | 768 x 3201 | `581ad58516fe607f561236a24ef3b7d17bbb05b43152e61d3187ce265acdcacf` |
| `task021-default-390.png` | PNG / `89504e470d0a1a0a` | 390 x 3054 | `75678fd341165599d7623085ab6de3bda7ed78a9aa2fdb7f95f37c423ea35767` |
| `task021-default-320.png` | PNG / `89504e470d0a1a0a` | 320 x 3211 | `2a1d32db038a31d0da417518ac841ecfdf90ca07937a9f7a10ec763a91298d8b` |
| `task021-console-errors.png` | JPEG/JFIF / `ffd8ffe000104a46` under historical `.png` name | 956 x 768 | `12f8a1d2405918e4f5c6696e1a9f10238a0ae2ff27ad8334d22a3dc41c524f4b` |
| `task021-native-invalid-navigation.png` | JPEG/JFIF / `ffd8ffe000104a46` under historical `.png` name | 956 x 768 | `4a8bef0c826d090adb848e40e099bb66bf91c648120669ed6c7549f48b532200` |
| `task021-native-standard-no-color.png` | JPEG/JFIF / `ffd8ffe000104a46` under historical `.png` name | 956 x 768 | `04183568541098938f2a11e8541f748adf180afe0f078d10ce6373b09dc9d305` |
| `task021-native-custom-no-input.png` | JPEG/JFIF / `ffd8ffe000104a46` under historical `.png` name | 956 x 768 | `6b9ed63924ebb19bc0d650cbbf150154638a8ef075c70280f53b760d9ed55aa3` |
| `task021-network-boundary.png` | JPEG/JFIF / `ffd8ffe000104a46` under historical `.png` name | 956 x 768 | `61c666f3b3ea918d5ce0fdae824435e2bec46f5b000c7db0ca685bb258e916c4` |
...
| File | SHA-256 |
|---|---|
| `task021-r2-client-boundary.png` | `5833da0363e2ef33fe223122de38cc48b8236f08cba4ca36ef10fe23d0db10b0` |
| `task021-r2-console-clean.png` | `a4cac829ca51cef911ebdd589e174913dc254e5f44612051e70e2ca13b036181` |
| `task021-r2-custom-input.png` | `9685157c05cd1f3dc1644e69d80674685c98ee5cf8e7a9bba6e278c85831f208` |
| `task021-r2-custom-replacement.png` | `6ba803ce2d3040e958fafc44c56cc131c7f67548c494bc62b0ab1953d1d5640d` |
| `task021-r2-invalid-native.png` | `e45f2a1a42737c438b6c9bf07aef6b5e45400cd35036777c203407854394ad1a` |
| `task021-r2-network-clean.png` | `f34be2bd81634c8fe38cfa72e1fbf047d73a27f8e950b5005ed4cbe3ee51bcf6` |
| `task021-r2-reduced-motion-320.png` | `ede9633d469884e0c6923f6eaf957632470975a3d671f6cbb1d2f9ca4e249ec9` |
| `task021-r2-responsive-1024.png` | `b8893447f4cbc67f818382c52f77b230c42f10e38172995f07d9936b738edaf8` |
| `task021-r2-responsive-1440.png` | `c57ebf63c996e461818b162897f141476c9da5550a090a6cd57e86eff5f51f55` |
| `task021-r2-responsive-320.png` | `0cb6cbd8f10be61b608c3446fdfaec8187c57205bbf0e239d216c8b5a4bdb30f` |
| `task021-r2-responsive-390.png` | `634e7e784b5fd1e2ae8080c5b5e7ea6bdeef5c04657ae015c887795b95c2e21c` |
| `task021-r2-responsive-768.png` | `be6dc45b540f92797314e04047886e36c2c6c71ff2cbb8b1d10aa23e20e1fee7` |
| `task021-r2-standard-result.png` | `7acca3d0a080e83a9070c0fd66141eaa7cede6d1d96e0befe05c3ff8ce70df73` |

Detailed native keyboard, AX, Network, Console, byte-boundary and measurement evidence is recorded in `ROUND_2_BROWSER_LOG.md`.
