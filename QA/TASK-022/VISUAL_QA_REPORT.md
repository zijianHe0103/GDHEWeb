...
| --- | --- | --- |
| Empty and final empty | `task022-empty-1440.png`, `task022-empty-final-320.png` | PASS |
| Product success | `task022-product-success-1440.png`, `task022-product-success-390.png` | PASS |
| Merge and split N-state | `task022-basket-two-1440.png`, `task022-basket-two-1024.png`, `task022-basket-two-768.png`, `task022-basket-two-390.png`, `task022-basket-two-320.png` | PASS |
| Single remaining line | `task022-basket-one-1440.png` | PASS |
| Native Add/focus/remove | `task022-native-focus-add.png`, `task022-native-added.png`, `task022-native-focus-remove.png` | PASS |
| Reduced motion/reflow | `task022-native-reduced-320.png` | PASS |
| Network boundary | `task022-native-network-320.png` | PASS |
| Exact execution details | `BROWSER_INTERACTION_LOG.md` | PASS |
| Encoding/dimensions/hashes | `EVIDENCE_INVENTORY.sha256` | PASS |

## Encoding disclosure

All 15 files have actual JPEG/JFIF bytes with magic prefix `ffd8ffe000104a4649460001` despite their `.png` names. Exact dimensions and SHA-256 values are preserved in `EVIDENCE_INVENTORY.sha256`. No visual file was renamed, re-encoded or edited.
