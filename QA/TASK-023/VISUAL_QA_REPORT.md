...
| --- | --- | --- |
| Initial five widths | `task023-initial-1440/1024/768/390/320.png` | PASS |
| Pointer 3 -> 6 -> 7 | `task023-expanded-six-1440/320.png`, `task023-final-seven-1440/320.png` | PASS |
| Quantity/Add/Basket | `task023-accessory-added-320.png`, `task023-basket-accessory-320.png` | PASS |
| Native focus progression | `task023-native-focus-show-more.png`, `task023-native-six-focus.png`, `task023-native-seven-focus.png` | PASS |
| Native accessory Add | `task023-native-focus-accessory-add.png`, `task023-native-accessory-added.png` | PASS |
| Reduced motion | `task023-native-reduced-320.png` | PASS |
| Network/Console | `task023-native-network-320.png`, `task023-native-console-warning.png` | PASS with disclosed development advisory |
...
| Encoding/dimensions/hashes | `QA/TASK-023/EVIDENCE_INVENTORY.sha256` and canonical manifest | verified |
...
Seventeen fresh files use the `task023-r2-*` prefix. All are actual JPEG/JFIF bytes under `.png` names, with exact magic, dimensions and SHA-256 appended to `QA/TASK-023/EVIDENCE_INVENTORY.sha256` and the canonical manifest. Round 1 evidence remains byte-identical.
