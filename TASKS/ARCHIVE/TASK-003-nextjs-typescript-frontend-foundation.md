...
- `TASKS/ARTIFACTS/TASK-003/EXECUTION_REPORT.md`
...
- Artifact: `TASKS/ARTIFACTS/TASK-003/ADVERSARIAL_REVIEW_REPORT.md`。
...
- Frontend artifact: `TASKS/ARTIFACTS/TASK-003/TEST_OR_VALIDATION_LOG.md`。
