...
| adversarial_reviewer | 独立只读审查模板、历史、scope、Git main 和远端完成条件 | `TASKS/ARTIFACTS/TASK-006/ADVERSARIAL_REVIEW_REPORT.md`、`LANES/adversarial_reviewer/**` | PASS/FAIL/BLOCKED review | user-authorized closure review dispatched |
