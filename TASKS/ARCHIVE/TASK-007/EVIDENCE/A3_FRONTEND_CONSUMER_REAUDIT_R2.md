...
Fresh `shasum -a 256 -c TASKS/ARCHIVE/TASK-007/EVIDENCE/machine/HANDOFF_CHECKSUMS.sha256` completed successfully for all 55 entries, including every file in the 19-file graph.
