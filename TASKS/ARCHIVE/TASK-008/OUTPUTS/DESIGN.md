...
- 错误样例权威源：`frontend/src/lib/cms/contracts/fixtures/ERROR_CONTRACT_FIXTURES.json`
...
- Product：`frontend/src/lib/cms/contracts/fixtures/golden-a3/resolve-product-alpha.json`
- Page：`frontend/src/lib/cms/contracts/fixtures/golden-a3/resolve-home.json`
