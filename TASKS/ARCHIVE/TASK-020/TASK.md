...
closed_at: 2026-08-01T15:26:27Z
legacy_delivery_closed_at: 2026-08-01T15:51:20Z
status: CLOSED
owner_lane: planner
assigned_lanes: ["frontend", "visual_qa", "validation"]
...
- `TASKS/ARCHIVE/TASK-020/OUTPUTS/REQUIREMENTS.md`：确认后的交互、字段、状态和边界。
- `TASKS/ARCHIVE/TASK-020/OUTPUTS/DESIGN.md`：server/client 数据流、DTO、QuoteLine 构造与失败状态设计。
...
先读 `AGENTS.md`、`PROJECT/COORDINATION.md`、`PROJECT/AGENT_LANES.md`、`LANES/registry/lanes.json`、本任务文件，再读 `PROJECT/STATE.md`、`TASKS/BOARD.md`、ADR-006、`TASKS/ARCHIVE/TASK-019/TASK.md`、Product Configuration 与 QuoteLine 合同。
...
- `TASKS/ARCHIVE/TASK-020/OUTPUTS/REQUIREMENTS.md`；
- `TASKS/ARCHIVE/TASK-020/OUTPUTS/DESIGN.md`；
- `TASKS/ARCHIVE/TASK-020/EVIDENCE/PROTECTED_BASELINE.md`。
