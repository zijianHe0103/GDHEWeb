...
closed_at: 2026-08-04T18:39:41Z
legacy_delivery_closed_at: 2026-08-04T18:48:00Z
status: CLOSED
owner_lane: planner
...
- `TASKS/ARCHIVE/TASK-021/OUTPUTS/REQUIREMENTS.md`：长度、颜色、Article Number 解析和无安装字段 QuoteLine 规则。
- `TASKS/ARCHIVE/TASK-021/OUTPUTS/DESIGN.md`：版本化合同、WordPress 投影、server-only DTO 与 UI 状态设计。
...
先读 `AGENTS.md`、`PROJECT/COORDINATION.md`、`PROJECT/AGENT_LANES.md`、`LANES/registry/lanes.json`、本任务文件，再读 `PROJECT/STATE.md`、`TASKS/BOARD.md`、TASK-012 `REAL_PRODUCT_VALIDATION_GATE.md`、`TASKS/ARCHIVE/TASK-019/TASK.md` 和 `TASKS/ARCHIVE/TASK-020/TASK.md`。
