...
closed_at: 2026-08-05T02:16:33Z
legacy_delivery_closed_at: 2026-08-05T02:25:25Z
status: CLOSED
owner_lane: planner
...
- `TASKS/ARCHIVE/TASK-022/OUTPUTS/REQUIREMENTS.md`：Quote Basket 术语、公开数据、合并/分行、30 天过期、编辑/删除和错误规则。
- `TASKS/ARCHIVE/TASK-022/OUTPUTS/DESIGN.md`：存储合同、状态机、跨标签同步、客户端边界、路由和苹果式条目设计。
...
先读 `AGENTS.md`、`PROJECT/COORDINATION.md`、`PROJECT/AGENT_LANES.md`、`LANES/registry/lanes.json`、本任务文件，再读 `PROJECT/STATE.md`、`TASKS/BOARD.md`、`TASKS/ARCHIVE/TASK-019/TASK.md`、TASK-021 `PUBLIC_QUOTE_DRAFT_AUTHORITY_DECISION.md`、ADR-006 和前端询价合同。
