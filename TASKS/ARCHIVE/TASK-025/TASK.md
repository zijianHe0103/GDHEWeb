...
git_status: MERGED
closed_at: 2026-08-11T13:51:29Z
legacy_delivery_closed_at: 2026-08-11T14:49:34Z
...
- `TASKS/ARCHIVE/TASK-025/EVIDENCE/integration/REQUIREMENTS.md`：最终公开/非展示 Article Number 规则、混合行边界与非目标。
- `TASKS/ARCHIVE/TASK-025/EVIDENCE/integration/DESIGN.md`：版本迁移、WordPress 批量校验、Next.js server-only consumer 和失败原子性设计。
