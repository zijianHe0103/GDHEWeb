...
git_status: MERGED
closed_at: 2026-08-12T03:52:49Z
legacy_delivery_closed_at: 2026-08-12T04:00:42Z
...
- `TASKS/ARCHIVE/TASK-026/OUTPUTS/REQUIREMENTS.md`：2.0 继承规则、Article Number 边界、非目标和后续实施门。
- `TASKS/ARCHIVE/TASK-026/OUTPUTS/RFQ_SUBMISSION_V2_CONTRACT.md`：公开请求、服务端权威文档、公开回执/错误的字段字典和跨字段规则。
- `TASKS/ARCHIVE/TASK-026/OUTPUTS/BASKET_V3_TO_SUBMISSION_V2_MAPPING.md`：Quote Basket `3.0.0` 到 Submission `2.0.0` 的确定性投影，明示排除展示专用字段。
- `TASKS/ARCHIVE/TASK-026/OUTPUTS/SECURITY_AND_IDEMPOTENCY_INHERITANCE.md`：TASK-024 哪些规则原样继承，哪些因 Article Number 和 v2 canonical bytes/HMAC 必须新增固定向量。
