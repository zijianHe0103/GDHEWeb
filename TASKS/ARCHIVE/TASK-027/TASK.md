...
closed_at: 2026-08-12T07:18:50Z
legacy_delivery_closed_at: 2026-08-12T07:26:44Z
...
- A0：`REQUIREMENTS.md`、`A0_DESIGN.md`、`TDD_SEAMS.md`、`A0_PROTECTED_BASELINE.md`、`A0_PROTECTED_CHECKSUMS.sha256`、`A0_VALIDATION_LOG.md`。
- A1：`FRONTEND_A1_EXECUTION_REPORT.md`、`FRONTEND_A1_VALIDATION_LOG.md`。
- A2：`FRONTEND_A2_EXECUTION_REPORT.md`、`FRONTEND_A2_VALIDATION_LOG.md`。
- A3：`FRONTEND_A3_EXECUTION_REPORT.md`、`FRONTEND_A3_VALIDATION_LOG.md`（保留初次 FAIL，当前 PASS_AFTER_NARROW_REVISION）。
- A4：`FRONTEND_A4_EXECUTION_REPORT.md`、`FRONTEND_A4_VALIDATION_LOG.md`。
- A5：`FRONTEND_A5_EXECUTION_REPORT.md`、`FRONTEND_A5_VALIDATION_LOG.md`（保留初次 FAIL，当前 PASS_AFTER_NARROW_REVISION）。
