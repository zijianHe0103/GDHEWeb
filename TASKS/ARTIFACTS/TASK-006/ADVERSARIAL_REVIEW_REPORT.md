...
2. **TASK-005 五份 post-push dirty records 的 hash preservation matrix 覆盖了错误的第五份文件。**
   ...
   - `DIFF_OR_OUTPUT_SUMMARY.md` 的 “TASK-005 Post-push Governance Record Baseline” 却列入 `TASKS/ARCHIVE/INDEX.md`，没有列出从 active 路径迁移到 `TASKS/ARCHIVE/TASK-005-roadmap-api-integration-boundaries.md` 的 TASK-005 task record。
