...
2. Compare `schemaGraphFiles` and `schemaGraphSha256` in `TASKS/ARTIFACTS/TASK-007/A3_SCHEMA_VALIDATION.json` to this exact list.
3. Run `shasum -a 256` on each repository-relative file below, or run `shasum -a 256 -c TASKS/ARTIFACTS/TASK-007/HANDOFF_CHECKSUMS.sha256`.
