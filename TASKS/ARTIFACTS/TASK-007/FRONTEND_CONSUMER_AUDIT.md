...
| `TASKS/ARTIFACTS/TASK-007/CONTRACT_AND_HANDOFF_MANIFEST.md` | fixed versions, endpoint/error matrix, checksums, benchmark, cleanup and deferrals |
| `TASKS/ARTIFACTS/TASK-007/DETERMINISTIC_GOLDEN_REVISION.json` | two-lifecycle ID change and 9/9 Golden determinism |
| `TASKS/ARTIFACTS/TASK-007/CONTRACT_RUNTIME_SUMMARY.json` | 9 positive, 14 negative, ETag and fail-closed summary |
| `TASKS/ARTIFACTS/TASK-007/SCHEMA_VALIDATION.json` | 9 positive Golden validated against Draft 2020-12 schemas |
| `TASKS/ARTIFACTS/TASK-007/BENCHMARK.json` | origin request graph, payloads, p50/p95 and triggered comparison gate |
...
| `TASKS/ARTIFACTS/TASK-005/FRONTEND_INTEGRATION_BOUNDARY.md`，sections 3 through 6 | server-only adapter, runtime validation and freeze gates |
