...
- `TASKS/ARTIFACTS/TASK-013/URL_AND_CANONICAL_CONTRACT.md:7-23`
  freezes the exact route map;
- `TASKS/ARTIFACTS/TASK-013/OPEN_DECISIONS.md:38-64` records the confirmed
  route decision;
...
- `cms/wp-content/plugins/gdhe-site/tests/product-card-contract-test.php:244-265`
  ...
  overflow;
- `TASKS/ARTIFACTS/TASK-014/DESIGN.md:30-39` and
...
- TASK-013 freezes primary category families at
  ...
  (`TASKS/ARTIFACTS/TASK-013/URL_AND_CANONICAL_CONTRACT.md:7-19`).
...
- Current runtime evidence records all three role and identity negatives as
  ...
  positive
  (`TASKS/ARTIFACTS/TASK-014/PRODUCT_CARD_RUNTIME_VALIDATION.json:21-45`).
...
(`TASKS/ARTIFACTS/TASK-014/PRODUCT_CARD_ERROR_FIXTURES.json:54-78`).
