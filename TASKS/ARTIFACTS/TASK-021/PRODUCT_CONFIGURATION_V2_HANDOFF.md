...
- manifest: `TASKS/ARTIFACTS/TASK-021/PRODUCT_CONFIGURATION_V2_HANDOFF_MANIFEST.json`;
- checksums: `TASKS/ARTIFACTS/TASK-021/PRODUCT_CONFIGURATION_V2_HANDOFF_CHECKSUMS.sha256`;
- Golden: `TASKS/ARTIFACTS/TASK-021/golden-product-configuration-v2/fgd-x15-pvc.json`;
- error fixtures: `TASKS/ARTIFACTS/TASK-021/PRODUCT_CONFIGURATION_V2_ERROR_FIXTURES.json`;
